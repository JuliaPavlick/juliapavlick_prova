...
if ($_SESSION['perfil' !=1]){
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $nova_senha = !empty($_POST['nova_senha'])? password_hash($_POST['nova_senha']);
        ...
        if($stmt->execute()){
            ...
            echo"<script>alert('erro ao atualizar usuarios'); window.location.href='alterar_usuario.php?id=$id_usuario';</script>";
        }
    }
?>